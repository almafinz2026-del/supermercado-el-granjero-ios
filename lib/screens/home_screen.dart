    ...
    return Scaffold(
      ...
      drawer: Drawer(
        child: Builder(builder: (ctx) {
            ...
            drawerItems.add(
              Padding(
                ...
                child: Text(
                  ...
                  style: const TextStyle(fontSize: 11, fontWeight: FontWeight.w700, color: Tema.textMuted, letterSpacing: 1),
                ),
              ),
            );
          ...
          drawerItems.add(const Padding(padding: EdgeInsets.symmetric(horizontal: 20), child: Divider(color: Tema.cardBorder)));
          drawerItems.add(
            Container(
              margin: const EdgeInsets.symmetric(horizontal: 8, vertical: 1),
