          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text('Cobrar', style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w800, color: Tema.textDark)),
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    prefixIcon: const Icon(Icons.person, color: Tema.textMuted),
    ...
    return SafeArea(
      ...
      Padding(
        ...
        child: Row(children: [
          ...
          if (_searchQ.isNotEmpty)
            IconButton(
              icon: const Icon(Icons.clear, size: 20, color: Tema.textMuted),
              onPressed: () {
                _searchCtl.clear();
                setState(() => _searchQ = '');
              },
      ...
      Expanded(
        child: filtrados.isEmpty
            ? const Center(child: Text('No se encontraron productos', style: TextStyle(color: Tema.textMuted)))
            : GridView.builder(
              ...
              InkWell(
                ...
                child: Padding(
                  ...
                  child: Row(children: [
                    ...
                    Text('Carrito (${_cart.length})', style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: Tema.textDark)),
                    const Spacer(),
              ...
              if (_cartExpanded) ...[
                ...
                Padding(
                  ...
                  child: Row(children: [
                    ...
                    const SizedBox(width: 6),
                    const Text('Descuento', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Tema.textDark)),
                    const SizedBox(width: 8),
                    SizedBox(
                      width: 70,
                      height: 32,
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          border: OutlineInputBorder(borderRadius: BorderRadius.circular(6), borderSide: const BorderSide(color: Tema.cardBorder)),
                        ),
                  ...
                  children: [
                    ...
                    Row(children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          '/ $unidad',
                          style: const TextStyle(fontSize: 9, color: Tema.textSoft, fontWeight: FontWeight.w600),
                        ),
                      ),
                    ]),
                    const SizedBox(height: 4),
        ...
        child: Row(children: [
          ...
          Row(mainAxisSize: MainAxisSize.min, children: [
            SizedBox(
              ...
              child: IconButton(
                padding: EdgeInsets.zero,
                icon: const Icon(Icons.remove_circle_outline, size: 20, color: Tema.textSoft),
            ...
            SizedBox(
              ...
              child: Text(
                ...
                textAlign: TextAlign.center,
                style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: Tema.textDark),
              ),
            ),
            SizedBox(
              width: 28,
            ...
            SizedBox(
              ...
              child: Text(
                ...
                style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: Tema.textDark),
              ),
            ),
          ]),
        ]),
