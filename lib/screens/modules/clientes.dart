...
class _CliScreenState extends State<CliScreen> {
        ...
        builder: (ctx, setSt) => AlertDialog(
          ...
          content: SizedBox(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              _fld('Telefono', telCtl),
              _fld('Documento (CC/NIT)', docCtl),
              _fld('Email', emailCtl),
  ...
  Widget _buildCard(Map c) {
    ...
    final saldo = (c['saldo_pendiente'] ?? 0) as num;
    final credito = (c['credito_maximo'] ?? 0) as num;
    final uso = credito > 0 ? ((saldo / credito) * 100).clamp(0, 100).toDouble() : 0.0;
    ...
    return Dismissible(
      ...
      confirmDismiss: (_) => showDialog<bool>(
        ...
        builder: (ctx) => AlertDialog(
          ...
          content: const Text('¿Eliminar este cliente? Se eliminaran todos sus datos asociados.'),
          actions: [
            TextButton(onPressed: () => Navigator.pop(ctx, false), child: const Text('Cancelar')),
            TextButton(
              onPressed: () => Navigator.pop(ctx, true),
              child: const Text('Eliminar', style: TextStyle(color: Tema.danger)),
            ),
          ],
        ),
      ),
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text(
                    ...
                    style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 15, color: Tema.textDark),
                  ),
            ...
            Flexible(child: Row(children: [
              Flexible(child: Text(
                'Cred: ${Fb.formatMoney(credito)}  |  Saldo: ${Fb.formatMoney(saldo)}',
                maxLines: 1, overflow: TextOverflow.ellipsis,
...
class _ClienteDetalleState extends State<_ClienteDetalle>
  ...
  Future<void> _abrirDeudaManual() async {
    ...
    final ok = await showDialog<bool>(
      context: context,
      builder: (ctx) => AlertDialog(
        title: const Text('Registrar Deuda / Fiado Manual', style: TextStyle(fontWeight: FontWeight.w700)),
        content: Column(
      ...
      child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Expanded(
            child: Text(value.isEmpty ? '-' : value,
                ...
                style:
                    const TextStyle(fontSize: 13, color: Tema.textDark))),
      ]),
    );
  }
              ...
              child: Column(children: [
                ...
                Row(children: [
                  CircleAvatar(
                      backgroundColor: Tema.primary,
                      radius: 18,
                      child: Text(nombre[0].toUpperCase(),                          style: const TextStyle(
                              color: Colors.white,
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        ...
                        icon: const Icon(Icons.add_circle_outline, color: Tema.danger),
                        label: const Text('Registrar Deuda Manual', style: TextStyle(color: Tema.danger)),
                        style: OutlinedButton.styleFrom(
                          padding: const EdgeInsets.symmetric(vertical: 14),
