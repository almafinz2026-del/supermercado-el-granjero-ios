...
class _FiaScreenState extends State<FiaScreen> {
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const Text('Desglose:', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 13, color: Tema.textDark)),
            ...
            ...preview.map((p) => Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(children: [
                  ...
                  Text(p['fecha'].toString(), style: const TextStyle(fontSize: 11, color: Tema.textMuted)),
                ]),
                const SizedBox(height: 4),
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  Text('Saldo: ${Fb.formatMoney(p['saldo'])}', style: const TextStyle(fontSize: 12, color: Tema.danger)),
                  const Icon(Icons.arrow_forward, size: 14, color: Tema.textMuted),
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setSt) {
          return ConstrainedBox(
            ...
            child: AlertDialog(
              title: const Text('Nuevo Fiado', style: TextStyle(fontWeight: FontWeight.w700, color: Tema.textDark)),
              content: SingleChildScrollView(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setSt) {
          return ConstrainedBox(
            constraints: BoxConstraints(maxHeight: MediaQuery.of(ctx).size.height * 0.8),
            child: AlertDialog(
              title: const Text('Pagar Fiado', style: TextStyle(fontWeight: FontWeight.w700, color: Tema.textDark)),
              content: SingleChildScrollView(
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  Container(
                    width: double.infinity,
  ...
  static Widget _infoRow(String label, String value) {
    return Padding(
      ...
      child: Row(children: [
        Text('$label: ', style: const TextStyle(fontSize: 12, color: Tema.textSoft)),
        Text(value, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Tema.textDark)),
      ]),
    );
  }
  ...
  Widget _buildMain() {
    ...
    return Stack(children: [
      ...
      Expanded(
        child: fl.isEmpty
              ? ListView(children: const [Padding(padding: EdgeInsets.all(40), child: Text('No se encontraron deudores', textAlign: TextAlign.center, style: TextStyle(color: Tema.textMuted)))])
              : ListView.builder(
        ...
        child: Container(
          ...
          child: Row(children: [
            ...
            Expanded(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(children: [
                  Expanded(child: Text(nombre.toString(), maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 15, color: Tema.textDark))),
                ...
                Flexible(child: Row(children: [
                  ...
                  Flexible(child: Text(telefono.toString(), maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(fontSize: 12, color: Tema.textSoft))),
                  const SizedBox(width: 12),
                  Container(
                  ...
                  const Spacer(),
                  if (ultimo != null) ...[
                    const Icon(Icons.history, size: 11, color: Tema.textMuted),
                    const SizedBox(width: 3),
                    Text(ultimo.substring(0, 10), style: const TextStyle(fontSize: 10, color: Tema.textMuted)),
                  ],
                ])),
              ]),
            ),
            const SizedBox(width: 8),
            const Icon(Icons.chevron_right, color: Tema.textMuted),
          ]),
        ),
      ),
    );
  ...
  Widget _buildDetalle() {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
      // Header
      Container(
        decoration: const BoxDecoration(color: Colors.white, border: Border(bottom: BorderSide(color: Tema.cardBorder))),
        ...
        child: Row(children: [
          ...
          Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text(c['nombre'] ?? '', maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 16, color: Tema.textDark)),
              Flexible(child: Row(children: [
                if ((c['telefono'] ?? '').toString().isNotEmpty) ...[
                  const Icon(Icons.phone, size: 12, color: Tema.textMuted),
                  const SizedBox(width: 4),
                  Text(c['telefono'].toString(), maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(fontSize: 12, color: Tema.textSoft)),
                ...
                const SizedBox(width: 12),
                Flexible(child: Text('Fiados: ${c['fiados_activos'] ?? 0}', maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(fontSize: 12, color: Tema.textSoft))),
                ])),
              ]),
          ),
          IconButton(
      ...
      children: [
        ...
        Container(
          ...
          child: Row(children: [
            ...
            const SizedBox(width: 4),
            const Text('Seleccionar todos', style: TextStyle(fontSize: 13, color: Tema.textSoft)),
            const Spacer(),
        ...
        Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            const Text('Registrar Abono', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 15, color: Tema.textDark)),
            const SizedBox(height: 12),
            TextField(
            ...
            Row(children: [
              Expanded(
                child: ElevatedButton.icon(
                  ...
                  style: ElevatedButton.styleFrom(backgroundColor: Tema.primary, foregroundColor: Colors.white, padding: const EdgeInsets.symmetric(vertical: 12)),
                ),
              ),
            ]),
            const SizedBox(height: 8),
            Row(children: [
              Expanded(
                child: OutlinedButton.icon(
                  ...
                  style: OutlinedButton.styleFrom(foregroundColor: Tema.primary, padding: const EdgeInsets.symmetric(vertical: 12)),
                ),
              ),
              const SizedBox(width: 8),
              Expanded(
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        Expanded(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
              Flexible(child: Text(f['producto_nombre'] ?? 'Fiado #${f['id']}', maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 13, color: Tema.textDark))),
              const SizedBox(width: 8),
            ...
            Row(children: [
              ...
              const SizedBox(width: 3),
              Text(f['fecha'] ?? '', style: const TextStyle(fontSize: 11, color: Tema.textSoft)),
              const SizedBox(width: 12),
              Container(
              ...
              const SizedBox(width: 12),
              if (f['usuario'] != null) ...[
                const Icon(Icons.person, size: 10, color: Tema.textMuted),
                const SizedBox(width: 3),
                Text(f['usuario'].toString(), style: const TextStyle(fontSize: 11, color: Tema.textMuted)),
              ],
            ]),
          ]),
        ),
              ...
              Row(children: [
                ...
                Expanded(
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Text(a['fecha'] ?? '', maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(fontSize: 11, color: Tema.textMuted)),
                  ]),
                ),
                if (tipo.isNotEmpty)
                  Container(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const SizedBox(height: 12),
            const Text('Fiado asociado:', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 13, color: Tema.textDark)),
            const SizedBox(height: 4),
