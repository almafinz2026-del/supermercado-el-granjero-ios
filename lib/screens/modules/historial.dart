...
class _HistScreenState extends State<HistScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(children: [
                ...
                Expanded(
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text('Venta #${venta['id']}', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w800, color: Tema.textDark)),
                    Text('${_fmtDate(venta['fecha'] as String?)}  \u2022  ${_metodoLabel(_metodo(venta))}',
                        style: const TextStyle(fontSize: 13, color: Tema.textSoft)),
                  ]),
                ),
              ...
              const SizedBox(height: 16),
              Text('Productos', style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w700, color: Tema.textDark)),
      ...
      builder: (ctx) => AlertDialog(
        title: Row(children: [
          ...
          Text('Ticket Venta #${venta['id']}',
              style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: Tema.textDark)),
        ]),
        content: SizedBox(
          ...
          child: SingleChildScrollView(
            child: Container(
              ...
              child: SelectableText(
                buf.toString(),
                style: const TextStyle(fontFamily: 'monospace', fontSize: 11, color: Tema.textDark, height: 1.4),
              ),
            ),
          ),
        ),
                ...
                Row(children: [
                  ...
                  Expanded(
                    child: Text('Editar Venta #${venta['id']}',
                        style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: Tema.textDark)),
                  ),
                ]),
                const SizedBox(height: 16),
                ...
                InkWell(
                  ...
                  child: InputDecorator(
                    ...
                    child: Text(_fmtDate(fecha.toIso8601String()),
                        style: const TextStyle(fontSize: 14, color: Tema.textDark)),
                  ),
                ),
                const SizedBox(height: 12),
                ...
                Container(
                  ...
                  child: Column(children: [
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      const Text('Items', style: TextStyle(fontSize: 14, color: Tema.textSoft)),
                      Text('${editItems.length}', style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Tema.textDark)),
                    ]),
                    const SizedBox(height: 4),
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      const Text('Total', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: Tema.textDark)),
            ...
            Expanded(
              child: InkWell(
                ...
                child: Container(
                  ...
                  child: Row(children: [
                    const Icon(Icons.shopping_basket, size: 16, color: Tema.textMuted),
                    const SizedBox(width: 8),
                    Expanded(
                      child: Text(
                    ...
                    const Icon(Icons.chevron_right, size: 16, color: Tema.textMuted),
                  ]),
                ),
              ),
            ),
          ...
          Row(children: [
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Row(mainAxisSize: MainAxisSize.min, children: [
                  const Icon(Icons.numbers, size: 14, color: Tema.textMuted),
                  const SizedBox(width: 4),
                  Text('$qty', style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: Tema.textDark)),
                  const SizedBox(width: 4),
                  const Icon(Icons.edit, size: 12, color: Tema.textMuted),
                ]),
              ),
            ),
            ...
            InkWell(
              ...
              child: Container(
                ...
                child: const Icon(Icons.remove, size: 16, color: Tema.textSoft),
              ),
            ),
            const SizedBox(width: 4),
            InkWell(
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Row(mainAxisSize: MainAxisSize.min, children: [
                  const Icon(Icons.attach_money, size: 14, color: Tema.textMuted),
                  Text(Fb.formatMoney(pu), style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: Tema.textDark)),
                  const SizedBox(width: 4),
                  const Icon(Icons.edit, size: 12, color: Tema.textMuted),
                ]),
              ),
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
              const Text('Subtotal', style: TextStyle(fontSize: 10, color: Tema.textMuted)),
  ...
  Future<void> _editItemNumber(
    ...
    final result = await showDialog<String>(
      ...
      builder: (dCtx) => AlertDialog(
        title: Text(title, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: Tema.textDark)),
        content: TextField(
          controller: ctl,
                        ...
                        itemBuilder: (_, i) {
                          ...
                          return ListTile(
                            ...
                            subtitle: Text('Stock: $stock  |  ${Fb.formatMoney(price)}',
                                style: const TextStyle(fontSize: 11, color: Tema.textSoft)),
                            onTap: () {
                              setSheet(() {
                                items[idx]['id'] = p['id'];
        ...
        : Column(children: [
            ...
            Padding(
              ...
              child: Row(children: [
                ...
                if (_searchQ.isNotEmpty)
                  IconButton(
                    icon: const Icon(Icons.clear, size: 18, color: Tema.textMuted),
                    onPressed: () {
                      _searchCtl.clear();
                      setState(() => _searchQ = '');
                    },
  ...
  static Widget _infoRow(String label, String value) {
    return Padding(
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        Text(label, style: const TextStyle(fontSize: 13, color: Tema.textSoft)),
        Text(value, style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: Tema.textDark)),
      ]),
    );
  }
  ...
  static Widget _th(String text) {
    return Padding(
      ...
      child: Text(text, style: const TextStyle(fontSize: 11, fontWeight: FontWeight.w700, color: Tema.textSoft)),
    );
  }
  ...
  static Widget _td(String text, TextAlign align) {
    return Padding(
      ...
      child: Text(
        text,
        textAlign: align,
        style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Tema.textDark),
      ),
    );
  }
}
