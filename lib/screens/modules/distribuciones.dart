...
class _DisScreenState extends State<DisScreen> {
  ...
  Future<void> _deleteDistribucion(int idx) async {
    ...
    final confirm = await showDialog<bool>(
      context: context,
      builder: (ctx) => AlertDialog(
        title: const Text('Eliminar distribucion'),
  ...
  Widget build(BuildContext context) {
    if (_loading) {
      return const Center(child: CircularProgressIndicator(color: Tema.primary));
    }
      ...
      child: Column(
        ...
        children: [
          ...
          ...entries.map((e) => Padding(
            ...
            child: Row(children: [
              Expanded(child: Text(e.key, style: const TextStyle(fontSize: 13, color: Tema.textSoft))),
              Text(Fb.formatMoney(e.value), style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: Tema.primary)),
            ]),
          )),
          if (entries.isEmpty) const Text('Sin distribuciones', style: TextStyle(fontSize: 12, color: Tema.textMuted)),
        ],
      ),
    );
  }
                ...
                itemBuilder: (_, i) {
                  ...
                  return Container(
                    ...
                    child: ListTile(
                      ...
                      title: Text(nombre, style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: Tema.textDark)),
                      trailing: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          IconButton(
                            onPressed: () => _editCategoria(c),
                            icon: const Icon(Icons.edit, size: 16, color: Tema.textSoft),
                            visualDensity: VisualDensity.compact,
                          ),
                          IconButton(
                            onPressed: () => _deleteCategoria(c),
                            icon: const Icon(Icons.delete_outline, size: 16, color: Tema.danger),
                            visualDensity: VisualDensity.compact,
                          ),
                        ],
                      ),
            ...
            child: Row(
              children: [
                ...
                Text(
                  ...
                  style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Color(0xFFf9a825)),
                ),
              ],
            ),
          ),
              ...
              child: Row(
                children: [
                  ...
                  TextButton.icon(
                    ...
                    label: const Text('Equitativo', style: TextStyle(fontSize: 11)),
                  ...
                  children: [
                    ...
                    if (_restante != 0) ...[
                      Text(
                        ...
                        style: const TextStyle(fontSize: 11, color: Tema.textMuted),
                      ),
                    ],
                  ],
                ),
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: const Text('Realizar Distribucion'),
                  style: ElevatedButton.styleFrom(
                ...
                return Dismissible(
                  ...
                  child: Container(
                    ...
                    child: ExpansionTile(
                      ...
                      title: Text(
                        fecha,
                        style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: Tema.textDark),
                      ),
                      subtitle: Text(
                      ...
                      trailing: Row(
                        ...
                        children: [
                          ...
                          const Icon(Icons.swipe_left, size: 14, color: Tema.textMuted),
                        ],
                      ),
                      children: [
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    ...
                                    style: const TextStyle(fontSize: 12, color: Tema.textDark),
                                  ),
                                ),
                                Text(
                                  _fmtF(item['monto'] ?? 0),
...
class _EditItemsDialogState extends State<_EditItemsDialog> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: const Text('Editar items de distribucion'),
      content: SizedBox(
