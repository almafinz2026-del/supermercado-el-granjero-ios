...
class _CieScreenState extends State<CieScreen> {
  ...
  Future<void> _cerrarCaja() async {
    ...
    final ganancias = totalVenta - totalCosto;
        ...
        builder: (ctx) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              const Divider(),
              const Text('La caja ha sido cerrada exitosamente.', style: TextStyle(fontSize: 12, color: Tema.textMuted)),
            ],
          ),
          actions: [
            TextButton(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          if (!abierta) ...[
            const SizedBox(height: 10),
            const Text('No hay caja abierta. Abre una caja desde el modulo de Caja antes de realizar un cierre.', textAlign: TextAlign.center, style: TextStyle(color: Tema.textSoft, fontSize: 13)),
  ...
  Widget _buildCloseForm() {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(children: [Icon(Icons.calculate_rounded, color: Tema.primary, size: 20), const SizedBox(width: 8), const Text('Realizar Cierre', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: Tema.textDark))]),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                const Text('Diferencia', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Tema.textDark)),
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(backgroundColor: Tema.danger, padding: const EdgeInsets.symmetric(vertical: 16)),
            ),
          ),
        ],
      ),
  ...
  Widget _buildSummaryRow(IconData icon, String label, String value, Color color) {
    return Row(
      children: [
        ...
        const SizedBox(width: 10),
        Expanded(child: Text(label, style: const TextStyle(fontSize: 13, color: Tema.textSoft))),
        Text(value, style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: color)),
      ],
    );
  }
  ...
  Widget _buildHistorial() {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(children: [Icon(Icons.history_rounded, color: Tema.primary, size: 20), const SizedBox(width: 8), const Text('Historial de Cierres', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: Tema.textDark))]),
          const SizedBox(height: 12),
          Row(children: [
          ...
          if (filtrados.isEmpty)
            Padding(
              ...
              child: Center(child: Column(children: [
                ...
                const SizedBox(height: 8),
                const Text('Sin cierres registrados', style: TextStyle(color: Tema.textMuted, fontSize: 14)),
              ])),
            )
          else
            ...filtrados.map((c) {
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text(_formatFecha(fecha), style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: Tema.textDark)),
                      ...
                      if (obs.toString().isNotEmpty) ...[
                        const SizedBox(height: 6),
                        Text(obs.toString(), style: const TextStyle(fontSize: 12, color: Tema.textMuted, fontStyle: FontStyle.italic), maxLines: 2, overflow: TextOverflow.ellipsis),
                      ],
        ],
      ),
    ),
  ...
  Widget _dateBtn(String label, DateTime val, VoidCallback onTap) {
    return InkWell(
      ...
      child: InputDecorator(
        ...
        child: Text('${val.day.toString().padLeft(2, '0')}/${val.month.toString().padLeft(2, '0')}/${val.year}', style: const TextStyle(fontSize: 13, color: Tema.textDark)),
      ),
    );
  }
}
