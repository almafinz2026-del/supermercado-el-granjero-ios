...
class _ConScreenState extends State<ConScreen> {
  ...
  Widget _switchTile(IconData icon, String title, String subtitle, bool value, ValueChanged<bool> onChanged) {
    return SwitchListTile(
      ...
      title: Text(title, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Tema.textDark)),
      subtitle: Text(subtitle, style: const TextStyle(fontSize: 12, color: Tema.textMuted)),
      value: value,
      onChanged: onChanged,
        ...
        children: [
          ...
          Expanded(
            child: TextField(
              ...
              style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Tema.textDark),
              decoration: InputDecoration(
                labelText: label,
                hintText: hint,
                isDense: true,
                contentPadding: const EdgeInsets.symmetric(horizontal: 12, vertical: 10),
                labelStyle: const TextStyle(fontSize: 12, color: Tema.textSoft),
              ),
            ),
          ),
        ],
  ...
  Widget _statusTile() {
    return ListTile(
      ...
      subtitle: Text(
        ...
        style: const TextStyle(fontSize: 12, color: Tema.textMuted),
      ),
    );
  }
}
