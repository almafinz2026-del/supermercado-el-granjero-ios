...
class _CompScreenState extends State<CompScreen> {
  ...
  Future<void> _abrirForm([Map<dynamic, dynamic>? compra]) async {
    ...
    try {
      ...
      await Fb.setList('productos', productos);
  ...
  Future<void> _pagarCompra(Map<dynamic, dynamic> compra) async {
    final ok = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: const Text('Marcar como Pagada', style: TextStyle(fontWeight: FontWeight.w700, color: Tema.textDark)),
        content: SizedBox(
          ...
          style: const TextStyle(color: Tema.textSoft),
        ))),
        actions: [
          TextButton(onPressed: () => Navigator.pop(ctx, false), child: const Text('Cancelar')),
          ElevatedButton(onPressed: () => Navigator.pop(ctx, true), child: const Text('Pagar')),
        ],
      ),
    );
    if (ok != true) return;
  ...
  Future<void> _eliminarCompra(Map<dynamic, dynamic> compra) async {
    final ok = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(Tema.radiusLg)),
        title: const Text('Eliminar Compra', style: TextStyle(fontWeight: FontWeight.w700, color: Tema.textDark)),
          ...
          child: DropdownButtonFormField<String>(
            ...
            items: [
              ...
              ..._proveedores.map((p) => DropdownMenuItem<String>(
                value: p['id']?.toString() ?? '',
                child: Text(p['nombre']?.toString() ?? '', style: const TextStyle(fontSize: 13), overflow: TextOverflow.ellipsis),
              )),
            ],
            ...
            child: Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(children: [
                  ...
                  Expanded(
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Row(children: [
                        Expanded(
                          child: Text('Factura $factura', maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(fontWeight: FontWeight.w700, color: Tema.textDark, fontSize: 15)),
                        ),
                        _badge(pagado ? 'Pagada' : 'Pendiente', pagado ? Tema.primary : const Color(0xFFe65100)),
                      ]),
                      const SizedBox(height: 3),
                      Text(provNombre, maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(fontSize: 13, color: Tema.textSoft)),
                    ]),
                  ),
                ]),
                ...
                Row(children: [
                  ...
                  const Spacer(),
                  Text(Fb.formatMoney(total), style: const TextStyle(fontWeight: FontWeight.w800, color: Tema.primary, fontSize: 17)),
                  if (!pagado) ...[
                    const SizedBox(width: 8),
                    SizedBox(
                      height: 32,
  ...
  Widget _infoChip(IconData icon, String text) {
    return Row(mainAxisSize: MainAxisSize.min, children: [
      ...
      Text(text, style: const TextStyle(fontSize: 12, color: Tema.textSoft)),
    ]);
  }
}
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          const SizedBox(width: 6),
          const Text('Buscar Producto', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 13, color: Tema.textDark)),
        ]),
              ...
              builder: (ctx, setSt) => Container(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Row(children: [
                    Expanded(
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text(prod['nombre']?.toString() ?? '', maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 13, color: Tema.textDark)),
                        Text('Cod: ${prod['codigo'] ?? '-'} | Stock: $stock', maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(fontSize: 11, color: Tema.textSoft)),
                      ]),
                    ),
                    Icon(Icons.chevron_right, size: 16, color: Tema.textMuted.withValues(alpha: 0.5)),
                  ]),
                  const SizedBox(height: 8),
                  Text('Precio compra anterior: ${Fb.formatMoney(precioAnt)}', style: const TextStyle(fontSize: 10, color: Tema.textMuted)),
                  ...
                  Row(children: [
                    Text('Subtotal: ${Fb.formatMoney(cant * precioCampo)}', style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 13, color: Tema.primary)),
                    const Spacer(),
                    ElevatedButton.icon(
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          const SizedBox(width: 6),
          const Text('Items de la Compra', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 13, color: Tema.textDark)),
          const Spacer(),
          Text('${_items.length} items', style: const TextStyle(fontSize: 12, color: Tema.textSoft)),
        ]),
        if (_items.isEmpty)
          const Padding(
            ...
            return Dismissible(
              ...
              child: Container(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Row(children: [
                  Expanded(
                    child: Text(nombre, maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 13, color: Tema.textDark)),
                  ),
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: const Icon(Icons.close, size: 14, color: Tema.danger),
                      ),
                    ),
                  ]),
                  const SizedBox(height: 6),
                  Row(children: [
                    Container(
                      ...
                      child: Row(mainAxisSize: MainAxisSize.min, children: [
                        InkWell(
                          ...
                          child: const Padding(padding: EdgeInsets.all(5), child: Icon(Icons.remove, size: 16, color: Tema.textDark)),
                        ),
                        SizedBox(
                          width: 36,
                          child: TextField(
                        ...
                        InkWell(
                          onTap: () => _updateItemCantidad(idx, 1),
                          borderRadius: BorderRadius.circular(4),
                          child: const Padding(padding: EdgeInsets.all(5), child: Icon(Icons.add, size: 16, color: Tema.textDark)),
                        ),
                      ]),
                    ),
                    const SizedBox(width: 10),
                    ...
                    const Spacer(),
                    Text(Fb.formatMoney(subtotal), style: const TextStyle(fontWeight: FontWeight.w800, color: Tema.primary, fontSize: 15)),
                  ]),
                ]),
              ),
            );
  ...
  Widget _buildTotales() {
    return Container(
      ...
      child: Column(children: [
        Row(children: [
          Text('Subtotal: ${Fb.formatMoney(_subtotal)}', style: const TextStyle(fontSize: 13, color: Tema.textSoft)),
          const Spacer(),
          Text('Descuento: ${Fb.formatMoney(_descuento)}', style: const TextStyle(fontSize: 13, color: Tema.textSoft)),
        ]),
        const SizedBox(height: 4),
        Row(children: [
          Text(_isIvaManual ? 'IVA: ${Fb.formatMoney(_iva)}' : 'IVA (19%): ${Fb.formatMoney(_iva)}', style: const TextStyle(fontSize: 13, color: Tema.textSoft)),
          const Spacer(),
          Text('Total: ${Fb.formatMoney(_total)}', style: const TextStyle(fontWeight: FontWeight.w800, color: Tema.primary, fontSize: 18)),
        ]),
        const SizedBox(height: 8),
        Row(children: [
          Expanded(
...
class _QuickProvDialogState extends State<_QuickProvDialog> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(Tema.radiusLg)),
      insetPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 24),
      title: Text('Nuevo Proveedor: ${widget.nombre}', maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(fontWeight: FontWeight.w700, color: Tema.textDark)),
      content: SizedBox(
        width: double.maxFinite,
        child: SingleChildScrollView(
        child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          Container(
            ...
            child: Row(children: [
              ...
              const SizedBox(width: 10),
              Expanded(
                child: Text('Detalle de Compra', maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w700, fontSize: 17)),
              ),
              IconButton(
                onPressed: () => Navigator.pop(context),
                icon: const Icon(Icons.close, color: Colors.white, size: 22),
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Container(
                  ...
                  child: Row(children: [
                    ...
                    Expanded(
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text('Factura $factura', maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(fontWeight: FontWeight.w800, fontSize: 16, color: Tema.textDark)),
                        const SizedBox(height: 2),
                        Text('$provNombre | $fecha', maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(fontSize: 12, color: Tema.textSoft)),
                      ]),
                    ),
                    Container(
                      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                ...
                const Text('Productos', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 15, color: Tema.textDark)),
                const SizedBox(height: 8),
                if (items.isEmpty)
                  const Padding(
                    ...
                    child: Column(children: [
                      ...
                      ...(items.map((item) {
                        ...
                        return Container(
                          ...
                          child: Row(children: [
                            Expanded(flex: 4, child: Text(nom, maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(fontSize: 12, color: Tema.textDark))),
                            Expanded(flex: 1, child: Text('$cant', style: const TextStyle(fontSize: 12, color: Tema.textDark), textAlign: TextAlign.center)),
                            Expanded(flex: 2, child: Text(_fmt(pu), style: const TextStyle(fontSize: 12, color: Tema.textSoft), textAlign: TextAlign.right)),
                            Expanded(flex: 2, child: Text(_fmt(sub), style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: Tema.primary), textAlign: TextAlign.right)),
                          ]),
                        );
                      })),
                    ]),
  ...
  Widget _miniStat(String label, String value, Color color) {
    return Expanded(
      child: Container(
        ...
        child: Column(children: [
          Text(label, style: const TextStyle(fontSize: 10, fontWeight: FontWeight.w600, color: Tema.textMuted)),
          const SizedBox(height: 2),
