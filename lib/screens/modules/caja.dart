...
class _CajaScreenState extends State<CajaScreen> with SingleTickerProviderStateMixin {
  ...
  Widget _resumenLinea(String label, String value) => Padding(
    ...
    child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
      Text(label, style: const TextStyle(color: Tema.textSoft)),
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: SizedBox(
          ...
          child: ConstrainedBox(
            ...
            child: movs.isEmpty
              ? const Padding(padding: EdgeInsets.all(24), child: Text('Sin movimientos', textAlign: TextAlign.center, style: TextStyle(color: Tema.textSoft)))
              : ListView.builder(
                  shrinkWrap: true,
                  ...
                  itemBuilder: (_, i) {
                    ...
                    return Container(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text('${_tipoTexto(t)}  •  ${_metodoTexto(m['metodo_pago'] as String?)}', style: const TextStyle(fontSize: 11, color: Tema.textSoft)),
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(label, style: const TextStyle(fontSize: 10, color: Tema.textSoft, fontWeight: FontWeight.w600)),
  ...
  Widget _buildEmptyMovimientos() {
    return Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
      ...
      const Text('Abre la caja para registrar movimientos', style: TextStyle(color: Tema.textSoft, fontSize: 14)),
    ]));
  }
  ...
  Widget _buildMovimientosTab() {
    ...
    if (movs.isEmpty) {
      return Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
        Icon(Icons.receipt_long_outlined, size: 52, color: Tema.textMuted.withValues(alpha: 0.4)),
        const SizedBox(height: 10),
        const Text('Sin movimientos registrados', style: TextStyle(color: Tema.textSoft, fontSize: 14)),
      ]));
    }
  ...
  Widget _buildHistorialTab() {
    ...
    if (reversed.isEmpty) {
      return Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        const SizedBox(height: 10),
        const Text('Sin historial de cajas', style: TextStyle(color: Tema.textSoft, fontSize: 14)),
      ]));
    }
    ...
    return ListView.builder(
      ...
      itemBuilder: (_, i) {
        ...
        return Card(
          margin: const EdgeInsets.symmetric(vertical: 4),
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(Tema.radius), side: const BorderSide(color: Tema.cardBorder)),
          elevation: 0,
          child: InkWell(
            ...
            child: Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(children: [
                  ...
                  Text('${_movs(c).length} movimientos', style: const TextStyle(fontSize: 11, color: Tema.textMuted)),
                  const Spacer(),
  ...
  Widget _hLine(String label, String value) {
    return Padding(
      ...
      child: RichText(text: TextSpan(children: [
        TextSpan(text: '$label: ', style: const TextStyle(fontSize: 11, color: Tema.textMuted, fontWeight: FontWeight.w500)),
        TextSpan(text: value, style: const TextStyle(fontSize: 11, color: Tema.textDark, fontWeight: FontWeight.w600)),
      ])),
    );
  }
}
