                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text(mesa.toString(),
                    ...
                    if (cliente.toString().isNotEmpty) ...[
                      ...
                      Row(children: [
                        const Icon(Icons.person_outline, size: 12, color: Tema.textSoft),
                    ...
                    Row(children: [
                      const Icon(Icons.shopping_basket_outlined, size: 13, color: Tema.textSoft),
                      const SizedBox(width: 3),
                      Text('$count items', style: const TextStyle(fontSize: 12, color: Tema.textSoft)),
                      ...
                      if (tiempo.isNotEmpty) ...[
                        const SizedBox(width: 10),
                        const Icon(Icons.access_time, size: 12, color: Tema.textSoft),
                        const SizedBox(width: 2),
                        Text(tiempo, style: const TextStyle(fontSize: 11, color: Tema.textSoft)),
                      ],
                    ]),
                  ]),
                ),
      ...
      body: Column(children: [
        ...
        Expanded(
          ...
          child: filtrados.isEmpty
              ? const Center(child: Text('Sin productos', style: TextStyle(color: Tema.textMuted)))
              : GridView.builder(
                      ...
                      child: Container(
                        ...
                        Expanded(
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            Text(it['nombre'] ?? '',
                                maxLines: 1, overflow: TextOverflow.ellipsis,
                                style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 13, color: Tema.textDark)),
                            Text(
            ...
            child: Row(children: [
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
                  const Text('Total', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: Tema.textSoft)),
                  const SizedBox(height: 1),
                  Text(Fb.formatMoney(total),
